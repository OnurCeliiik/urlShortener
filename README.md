...
**Write service** owns commands: validation, optional custom codes, code generation, uniqueness, and persistence. It never redirects. Schema migrations live here.
...
Both services speak to the same `urls` table (`short_code`, `original_url`, `created_at`).
...
- Read service: [url-shortener-read/README.md](url-shortener-read/README.md)
